...
#
listeningPosts <- list(expand.grid(x = c(-11000, -10000, -9000), y = 7500),
                       expand.grid(x = c(11000, 10000, 9000), y = 7500),
                       expand.grid(x = c(-1000, 0, 1000), y = c(0)),
                       expand.grid(x = c(-11000, -10000, -9000), y = -7500),
                       expand.grid(x = c(11000, 10000, 9000), y = -7500))
nOccasion <- 5
sigmaMove <- sqrt((30 * 10000) / pi)
...
mask <- ascr::create.mask(lapply(listeningPosts, as.matrix), buffer = 5000)
